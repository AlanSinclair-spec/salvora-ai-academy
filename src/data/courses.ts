...
export const courses: Course[] = [
  {
    ...
    longDescription: "Aprende que es la IA, como funciona Grok y como esta tecnologia esta transformando El Salvador y el mundo.",
    icon: "Brain",
    color: "blue",
    targetAudience: "all",
    difficulty: "beginner",
    ...
    units: [
      {
        id: "intro-que-es-ia",
        title: "Que es la IA?",
        description: "Conceptos basicos de Inteligencia Artificial",
        order: 1,
        lessons: [
          {
          ...
          {
            id: "intro-1-definicion",
            title: "Definicion de Inteligencia Artificial",
            type: "video",
            duration: "10 min",
            videoId: "placeholder-definition",
            order: 2,
          },
          {
            id: "intro-1-el-salvador",
            title: "IA en El Salvador",
            type: "reading",
            duration: "8 min",
            order: 3,
          },
          {
            id: "intro-1-practica",
            title: "Practica: Explicar IA en tus palabras",
            type: "quiz",
            duration: "10 min",
            order: 4,
          },
      ...
      {
        id: "intro-como-funciona-grok",
        title: "Como funciona Grok?",
        description: "Conoce el asistente de IA de xAI",
        order: 2,
        lessons: [
          {
            id: "intro-2-grok",
            ...
            type: "video",
            duration: "8 min",
            videoId: "placeholder-grok",
            order: 1,
          },
          {
            id: "intro-2-modelos",
            title: "Modelos de lenguaje explicados",
            type: "reading",
            duration: "12 min",
            order: 2,
          },
          {
            id: "intro-2-buenas-preguntas",
            title: "Como hacer buenas preguntas",
            type: "video",
            duration: "10 min",
            videoId: "placeholder-questions",
            order: 3,
          },
          {
            id: "intro-2-ejercicio",
            title: "Ejercicio guiado: Tu primera conversacion",
            type: "practice",
            duration: "15 min",
            order: 4,
          },
